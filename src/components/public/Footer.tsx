...
export default function Footer({
  ...
  const socialLinks = [
    ...
    { url: linkedinUrl, key: "linkedin", label: "LinkedIn" },
    { url: whatsappUrl, key: "whatsapp", label: "WhatsApp" },
    { url: telegramUrl, key: "telegram", label: "Telegram" },
    { url: tiktokUrl, key: "tiktok", label: "TikTok" },
    { url: threadsUrl, key: "threads", label: "Threads" },
    { url: blueskyUrl, key: "bluesky", label: "Bluesky" },
    { url: spotifyUrl, key: "spotify", label: "Spotify" },
  ].filter((s) => s.url);
